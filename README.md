...
### Manually implenenting WebAuthn forms
...
<form action="/passkeys" method="post">
  <webauthn-create create-options="<%= create_passkey_options(@user).to_json %>">
...
<form action="/users/sign_in" method="post">
  <webauthn-get get-options="<%= passkey_authentication_options.to_json %>">
    <input type="hidden" name="public_key_credential" class="js-webauthn-response">
